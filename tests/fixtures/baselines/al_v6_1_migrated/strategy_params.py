...
2. Call the ``generate_strategy_params`` MCP tool (echolon-mcp) or use the
   ``ParameterAgent`` in ``modules/coding_agent/compose_strategy/strategy_agent``
3. Validate output with the PreRuntimeValidator / debugger agents.
"""
