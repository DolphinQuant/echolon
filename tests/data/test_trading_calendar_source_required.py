"""SHFELiveDayExtractor requires source_path for trading calendar."""
...
def test_no_hardcoded_quant_engine_path_reference():
    ...
    src = Path(__import__("echolon.data.extractors.shfe.live_day_extractor", fromlist=["__file__"]).__file__).read_text()
