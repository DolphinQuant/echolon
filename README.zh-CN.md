...
**端到端可用**(生产级,每天都在跑):
- SHFE 日线期货研究 — 数据采集、217 个指标的目录、Backtrader 引擎、Optuna TPE 优化(单目标和多目标都支持)、带部署就绪打分的滚动窗口分析(walk-forward analysis)、基于 KMeans 的鲁棒试验筛选。
- Agent 接入层 — 22 个 MCP 工具、23 个 skill、31 个错误码、3 个能跑的策略模板。
